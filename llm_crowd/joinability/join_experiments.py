...
def response_suffwtemp(prompt_tmp, tbl1, tbl2, col1, col2, temp_val, few_shot=None, timeout=30):
    ...
    if few_shot != None:
        prompt = prompt_tmp.get_chat(tbl1, tbl2, col1, col2, few_shot, followup)
        chat += prompt
    else:
        fullprompt = prompt_tmp.get_prompt_nospaces(tbl1, tbl2, col1, col2)
...
if __name__=='__main__':
    ...
    candfile = 'aurum_fullmatcheswgt.csv'
